...
export const getTwoGoExpressDoc = (combine, listLength, docList, doc, item, services, shipperDetails) => {
  console.log("getTwoGoExpressDoc")
  ...
  const twoGoExpressLogoImg = document.querySelector('#twoGoExpressLogo');
  const twoGoExpressLogoBase64Str = getLogoBase64Str(twoGoExpressLogoImg);
  doc.addImage(twoGoExpressLogoBase64Str, 'PNG', 8, 14, 18, 8.5, '', 'FAST');
  ...
  doc.setFontType('bold');
  doc.setFontSize(8);
  doc.text('For 2Go Express', 28, 125);
  ...
  doc.addImage(secondBarcodeImgData, "PNG", 9, 127, 60, 15, '', 'FAST');

  doc.line(73, 145, 73, 121);
