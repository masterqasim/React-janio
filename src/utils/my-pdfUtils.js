...
export const getPublicParcelDoc = (combine, listLength, docList, doc, item, services, shipperDetails) => {
  console.log("getPublicParcelDoc")
  ...
  doc.setFontType('bold');
  doc.setFontSize(8);
  doc.text('For Public Parcel', 41, 125);
